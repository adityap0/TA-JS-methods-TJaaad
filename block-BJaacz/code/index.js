...
function addThreeToArray (num = [])
{
  for(let i =0; i<num.length; i++)
  { 
    num[i] = addThree(num[i]);
  }
  return num;
}
addThreeToArray([1,3,2,5]);
/*
...
*/
function changeArray(num = [], cb)
{
  let finalArray = [];
  for(let i=0; i<num.length; i++)
  {
    finalArray[i] = cb(num[i]);
  }
  return finalArray;
}
/*
